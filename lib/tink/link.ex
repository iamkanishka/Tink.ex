defmodule Tink.Link do
  ...
  """
  @spec build_url(
          :account_check | :expense_check | :income_check | :payment | :risk_insights | :transactions,
          map()
        ) :: String.t()
  ...
  # Fix: bind the full params map so we can call Map.get/2 on it inside the clause
  defp add_test_params(query, %{test: true} = params) do
    query
    |> Map.put("test", "true")
