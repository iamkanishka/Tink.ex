defmodule TinkEx.RiskCategorisation do
  @moduledoc """
  ...
  ## Flow
      ...
      client = TinkEx.client(scope: "risk-categorisation:readonly")

      # Step 3: Retrieve risk categorisation report
      {:ok, report} = TinkEx.RiskCategorisation.get_report(client, risk_categorisation_id)
  ...
  ## Parameters
    ...
    * `client` - TinkEx client with `risk-categorisation:readonly` scope
  ...
  ## Examples
      ...
      {:ok, report} = TinkEx.RiskCategorisation.get_report(client, "risk_cat_abc123")
      #=> {:ok, %{
      #     "id" => "risk_cat_abc123",
      #     "userId" => "user_123",
      #     "status" => "COMPLETED",
  ...
  ## Use Cases
      ...
      {:ok, report} = TinkEx.RiskCategorisation.get_report(client, report_id)
