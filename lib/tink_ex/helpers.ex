defmodule TinkEx.Helpers do
  @moduledoc """
  Helper functions and utilities for TinkEx.
  ...
  ## Examples
      ...
      url = TinkEx.Helpers.build_url("/api/v1/accounts", page_size: 10, page_token: "abc")
      #=> "/api/v1/accounts?page_size=10&page_token=abc"

      # Parse money amount
      amount = TinkEx.Helpers.parse_money(%{"value" => "123.45", "currencyCode" => "USD"})
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.build_url("/api/v1/accounts", page_size: 10)
      "/api/v1/accounts?page_size=10"

      iex> TinkEx.Helpers.build_url("/api/v1/accounts", [])
      "/api/v1/accounts"
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.build_query_string(foo: "bar", baz: 123)
      "foo=bar&baz=123"

      iex> TinkEx.Helpers.build_query_string(foo: nil, bar: "baz")
      "bar=baz"
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.to_camel_case("page_size")
      "pageSize"

      iex> TinkEx.Helpers.to_camel_case("page_token")
      "pageToken"
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.parse_money(%{"value" => "123.45", "currencyCode" => "USD"})
      %{amount: Decimal.new("123.45"), currency: "USD"}

      iex> TinkEx.Helpers.parse_money(%{"value" => 123.45, "currencyCode" => "EUR"})
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.parse_decimal("123.45")
      #Decimal<123.45>

      iex> TinkEx.Helpers.parse_decimal(123.45)
      #Decimal<123.45>

      iex> TinkEx.Helpers.parse_decimal(nil)
      #Decimal<0>
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.format_date(date)
      "2024-01-15"

      iex> TinkEx.Helpers.format_date("2024-01-15")
      "2024-01-15"
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.parse_date("2024-01-15")
      {:ok, ~D[2024-01-15]}

      iex> TinkEx.Helpers.parse_date("invalid")
      {:error, :invalid_date}
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.get_in_safe(map, ["user", "name"])
      "John"

      iex> TinkEx.Helpers.get_in_safe(map, ["user", "age"])
      nil
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.merge_pagination_params([page_size: 10], "token123")
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.validate_required(params, [:user_id, :scope])
      :ok
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.encode_json(%{foo: "bar"})
      {:ok, ~s({"foo":"bar"})}

      iex> TinkEx.Helpers.encode_json(nil)
      {:ok, nil}
  """
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.decode_json(~s({"foo":"bar"}))
      {:ok, %{"foo" => "bar"}}

      iex> TinkEx.Helpers.decode_json("invalid")
  ...
  ## Examples
      ...
      iex> TinkEx.Helpers.redact_sensitive(%{access_token: "secret", data: "public"})
