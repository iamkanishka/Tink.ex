defmodule TinkEx.BusinessAccountCheck do
  @moduledoc """
  ...
  ## Flow
      ...
      client = TinkEx.client(scope: "business-account-verification-reports:read")

      # Step 3: Retrieve report
      {:ok, report} = TinkEx.BusinessAccountCheck.get_report(client, report_id)
  ...
  ### Business KYC Verification
      ...
      def verify_business_account(business_id) do
        ...
        {:ok, report} = TinkEx.BusinessAccountCheck.get_report(
          client,
  ...
  ## Parameters
    ...
    * `client` - TinkEx client with `business-account-verification-reports:read` scope
  ...
  ## Examples
      ...
      {:ok, report} = TinkEx.BusinessAccountCheck.get_report(client, "report_abc123")
      #=> {:ok, %{
      #     "id" => "report_abc123",
      #     "verified" => true,
