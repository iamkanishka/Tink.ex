defmodule TinkEx.CashFlow do
  ...
  ## Flow
      ...
      {:ok, summaries} = TinkEx.CashFlow.get_summaries(client,
        resolution: "MONTHLY",
        from_gte: "2024-01-01",
        to_lte: "2024-12-31"
      )
  ...
  ### Cash Flow Trends
      ...
      def identify_cash_flow_trends(client) do
        {:ok, weekly} = TinkEx.CashFlow.get_summaries(client,
          resolution: "WEEKLY",
  ...
  ## Examples
      ...
      {:ok, monthly} = TinkEx.CashFlow.get_summaries(client,
        resolution: "MONTHLY",
        from_gte: "2024-01-01",
        to_lte: "2024-12-31"
      )
      ...
      {:ok, daily} = TinkEx.CashFlow.get_summaries(client,
        resolution: "DAILY",
        from_gte: "2024-01-01",
        to_lte: "2024-01-31"
      )
      ...
      # Get yearly overview
      {:ok, yearly} = TinkEx.CashFlow.get_summaries(client,
        resolution: "YEARLY",
        from_gte: "2020-01-01",
        to_lte: "2024-12-31"
      )
