defmodule TinkEx.Loans do
  ...
  ## Flow
      ...
      {:ok, loans} = TinkEx.Loans.list_accounts(user_client)

      # Step 5: Get specific loan details
      loan_id = hd(loans["accounts"])["id"]
      {:ok, loan} = TinkEx.Loans.get_account(user_client, loan_id)
  ...
  ### Total Debt Calculation
      ...
      def calculate_total_debt(client) do
        {:ok, loans} = TinkEx.Loans.list_accounts(client)
  ...
  ## Examples
      ...
      {:ok, loan} = TinkEx.Loans.get_account(user_client, "loan_account_123")
      #=> {:ok, %{
      #     "id" => "loan_account_123",
      #     "name" => "Home Mortgage",
      #     "type" => "MORTGAGE",
  ...
  ## Use Cases
      ...
      {:ok, loan} = TinkEx.Loans.get_account(client, loan_id)
